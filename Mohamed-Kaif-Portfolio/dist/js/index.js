...
function setupProjectsSection() {
  ...
  const PROJECTS = {
  "cyberdiag": {
    "desc": "A document-verification project that combines SHA-256 hashing with blockchain records to check whether a file has changed. Built with a React interface and Solidity / Ethereum smart-contract concepts.",
    ...
    "images": [
      "assets/images/kaif/sheproof-stack.svg",
      "assets/images/kaif/sheproof-workflow.svg"
    ]
  },
  "overtake": {
    "desc": "An image and audio deepfake-detection project explored for the Amazon Nova AI Hackathon. A Next.js interface and FastAPI backend support media analysis, probability estimates and confidence reporting. A prototype under development.",
    ...
    "images": [
      "assets/images/kaif/poneglyph-stack.svg",
      "assets/images/kaif/poneglyph-workflow.svg"
    ]
  },
  "anima": {
    "desc": "An AI-assisted tax-intelligence project that analyzes structured signals and highlights potential anomalies. Built around a Node.js / Express API, MongoDB storage and Gemini-assisted reasoning.",
    "category": "AI / Tax intelligence",
    "year": "2026",
    "tags": [
      "Node.js",
      "MongoDB",
    ...
    "images": [
      "assets/images/kaif/crisismind-stack.svg",
      "assets/images/kaif/crisismind-workflow.svg"
    ]
  },
  "beyond-the-clouds": {
    "desc": "A public-safety response project connecting simulated rainfall, water-level and traffic signals. It brings together data fusion, risk detection, AI and policy rules to support response plans, dashboard updates and escalation. In development.",
    ...
    "images": [
      "assets/images/kaif/nexus-stack.svg",
      "assets/images/kaif/nexus-workflow.svg"
    ]
  },
  "zenith": {
    "desc": "A natural-language AI request-engine project for turning user requests into structured, governance-oriented outputs. Built as a web application with Supabase configuration.",
    "category": "AI / Request engine",
    "year": "2026",
    "tags": [
      "AI",
      "Supabase",
    ...
    "images": [
      "assets/images/kaif/authforge-stack.svg",
      "assets/images/kaif/authforge-workflow.svg"
    ]
  },
  "skymcdb": {
    "desc": "A gamified Java-learning desktop project. Learners write and check code with JShell, earn coins and use them to grow a virtual garden. Explored using JavaFX, JDK 21 and Gson.",
    "category": "Java learning project",
    "year": "2026",
    "tags": [
      "Java",
      "JavaFX",
    ...
    "images": [
      "assets/images/kaif/codegarden-stack.svg",
      "assets/images/kaif/codegarden-workflow.svg"
    ]
  },
  "chromablock": {
    "desc": "An MSME billing and ERP project with an integrated AI business-intelligence layer. It brings sales, purchases and inventory together with planned forecasts, anomaly alerts and business queries, while keeping the owner in control. In development.",
    "category": "MSME ERP / In development",
    "year": "2026",
    "tags": [
      "Node.js",
      "PostgreSQL",
    ...
    "images": [
      "assets/images/kaif/chrissoft-stack.svg",
      "assets/images/kaif/chrissoft-workflow.svg"
    ]
  },
  "cyberdiag-app": {
    "desc": "A proposed privacy-first identity-verification API for travel. The concept explores reusable verification, blockchain-backed credentials and x402 pay-per-request access. Product and architecture exploration; not a production service.",
    "category": "Web3 / Product concept",
    "year": "2026",
    "tags": [
      "x402 concept",
      "Identity",
    ...
    "images": [
      "assets/images/kaif/travelpass-stack.svg",
      "assets/images/kaif/travelpass-workflow.svg"
    ]
  }
};
  ...
  const detailVisit = document.getElementById('detail-visit');
  ...
  function openProject(id, clickedItem) {
    ...
    if (proj.link) {
      detailVisit.href = proj.link;
      detailVisit.classList.add('has-link');
    } else {
    ...
    tl.to(detailVisit, { opacity: 1, duration: 0.5, ease: 'power2.out' }, 1.4);
  ...
  function closeProject() {
    ...
    tl.to([detailDesc, detailTags, detailVisit, detailBack], { opacity: 0, duration: 0.3, ease: 'power2.in' }, 0);
    ...
    tl.add(function () {
      ...
      gsap.set([detailTitleWrap, detailDesc, detailTags, detailVisit, detailBack, detailGalleryWrap], { opacity: 0 });
